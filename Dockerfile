...
RUN if [ "$MODEL_TYPE" = "flux1-schnell" ]; then \
      ...
      wget -q --header="Authorization: Bearer ${HUGGINGFACE_ACCESS_TOKEN}" -O models/lora/flux-lora.safetensors https://huggingface.co/CRIS2223/michi/resolve/main/flux-lora.safetensors && \
